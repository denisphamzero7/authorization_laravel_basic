...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Đăng bài viết</h1>
    </div>
    @if($errors->any())
    ...
    <form action="" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name= "title"class= "form-control" placeholder="Tên bài viết" value="{{old('title')}}">
            @error('title')
        ...
        <div class="mb-3">
            ...
            --}}
            <textarea name="content" class="form-control" placeholder="Nội dung bài viết" rows="5">{{ old('content') }}</textarea>
